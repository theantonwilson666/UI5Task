...
jQuery.sap.require("sap.m.AvatarColor");
 ...
 */
sap.m.FeedListItem.extend("sap.ca.ui.ExpansibleFeedListItem", /** @lends sap.ca.ui.ExpansibleFeedListItem.prototype */ {
	metadata: {
		deprecated: true,
		library: "sap.ca.ui",
		properties: {
...
sap.ca.ui.ExpansibleFeedListItem.prototype.onBeforeRendering = function () {
	if (sap.m.FeedListItem.prototype.onBeforeRendering) {
		sap.m.FeedListItem.prototype.onBeforeRendering.apply(this);
	}
	var oAvatar = this._getAvatar();
	oAvatar.setBackgroundColor(sap.m.AvatarColor.Transparent);
};
