tinymce.Resource.add("tinymce.plugins.advcode.CodeMirror", function() {
    ...
    window.CodeMirror = void 0, e = function() {
        ...
        function ee(e) {
            return /\w/.test(e) || "\x80" < e && (e.toUpperCase() != e.toLowerCase() || J.test(e));
        }
        function te(e, t) {
        ...
        var ue = function() {
            ...
            var z = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/, B = /[stwN]/, U = /[LRr]/, K = /[Lb1n]/, G = /[1n]/;
            function V(e, t, n) {
                this.level = e, this.from = t, this.to = n;
            }
            return function(e, t) {
                var n = "ltr" == t ? "L" : "R";
                if (0 == e.length || "ltr" == t && !z.test(e)) return !1;
                for (var r, i = e.length, o = [], l = 0; l < i; ++l) o.push((r = e.charCodeAt(l)) <= 247 ? E.charAt(r) : 1424 <= r && r <= 1524 ? "R" : 1536 <= r && r <= 1785 ? R.charAt(r - 1536) : 1774 <= r && r <= 2220 ? "r" : 8192 <= r && r <= 8203 ? "w" : 8204 == r ? "b" : "L");
                ...
                for (var O, A = [], F = 0; F < i; ) if (K.test(o[F])) {
                    var D = F;
                    ...
                    for (var H = W; H < F; ) if (G.test(o[H])) {
                        W < H && A.splice(P, 0, new V(1, W, H));
                        var I = H;
                        for (++H; H < F && G.test(o[H]); ++H) ;
                        A.splice(P, 0, new V(2, I, H)), W = H;
                    } else ++H;
                    W < F && A.splice(P, 0, new V(1, W, F));
                }
                return "ltr" == t && (1 == A[0].level && (O = e.match(/^\s+/)) && (A[0].from = O[0].length, 
                A.unshift(new V(0, 0, O[0].length))), 1 == X(A).level && (O = e.match(/\s+$/)) && (X(A).to -= O[0].length, 
                A.push(new V(0, i - O[0].length, i)))), "rtl" == t ? A.reverse() : A;
            };
        }();
        function ce(e, t) {
            var n = e.order;
        ...
        function Oe(e) {
            if (null == Me) {
                var t = A("span", "\u200b");
                N(e, A("span", [ t, document.createTextNode("x") ])), 0 != e.firstChild.offsetHeight && (Me = t.offsetWidth <= 1 && 2 < t.offsetHeight && !(x && C < 8));
            }
            var n = Me ? A("span", "\u200b") : A("span", "\xa0", null, "display: inline-block; width: 1px; margin-right: -1px");
        ...
        }, Pe = "oncopy" in (Fe = A("div")) || (Fe.setAttribute("oncopy", "return;"), "function" == typeof Fe.oncopy), He = null;
        var Ie = {}, Ee = {};
        function Re(e) {
        ...
        function at(e, t) {
            ...
            return t.line > o ? et(o, je(e, o).text.length) : (r = je(e, (n = t).line).text.length, 
        ...
        qe.prototype.eol = function() {
            ...
            this.lastColumnPos = this.start), this.lastColumnValue - (this.lineStart ? R(this.string, this.lineStart, this.tabSize) : 0);
        ...
        function ht(e, t, n) {
            if (!t.styles || t.styles[0] != e.state.modeGen) {
                var r = dt(e, Ye(t)), i = t.text.length > e.options.maxHighlightLength && Ke(e.doc.mode, r.state), o = ft(e, t, r);
        ...
        function pt(e, t, n, r) {
            var i = e.doc.mode, o = new qe(t, e.options.tabSize, n);
        ...
        function Mt(e, t) {
            ...
            var n = Qe(e, t.from.line) && je(e, t.from.line).markedSpans, r = Qe(e, t.to.line) && je(e, t.to.line).markedSpans;
            if (!n && !r) return null;
            var i = t.from.ch, o = t.to.ch, l = 0 == tt(t.from, t.to), a = function(e, t, n) {
                ...
                return r;
            }(r, o, l), u = 1 == t.text.length, c = X(t.text).length + (u ? i : 0);
        ...
        function Et(e, t, n, r, i) {
            var o = je(e, t), l = Ct && o.markedSpans;
            if (l) for (var a = 0; a < l.length; ++a) {
                var s = l[a];
                if (s.marker.collapsed) {
                    var u = s.marker.find(0), c = tt(u.from, n) || At(s.marker) - At(i), f = tt(u.to, r) || Ft(s.marker) - Ft(i);
        ...
        function qt(e) {
            ...
            n.maxLine = je(t, t.first), n.maxLineLength = Vt(n.maxLine), n.maxLineChanged = !0, 
            t.iter(function(e) {
                var t = Vt(e);
        ...
        function Xt(e, t) {
            ...
            var n = t.addModeClass ? $t : _t;
            return n[e] || (n[e] = e.replace(/\S+/g, "cm-$&"));
        }
        function Yt(e, t) {
            var n = O("span", null, null, b ? "padding-right: .1px" : null), r = {
            ...
            for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
                ...
                r.pos = 0, r.addToken = Qt, Ae(e.display.measure) && (l = ce(o, e.doc.direction)) && (r.addToken = Jt(r.addToken, l)), 
                r.map = [], tn(o, r, ht(e, o, t != e.display.externalMeasured && Ye(o))), o.styleClasses && (o.styleClasses.bgClass && (r.bgClass = P(o.styleClasses.bgClass, r.bgClass || "")), 
                o.styleClasses.textClass && (r.textClass = P(o.styleClasses.textClass, r.textClass || ""))), 
                0 == r.map.length && r.map.push(0, 0, r.content.appendChild(Oe(e.display.measure))), 
                ...
                if (u.test(t)) {
                    ...
                    for (var f = 0; ;) {
                        ...
                        if (d) {
                            ...
                            x && C < 9 ? a.appendChild(A("span", [ p ])) : a.appendChild(p), e.map.push(e.pos, e.pos + d, p), 
                            e.col += d, e.pos += d;
                        }
                        if (!h) break;
                        f += d + 1;
                        ...
                        if ("\t" == h[0]) {
                            ...
                            (g = a.appendChild(A("span", $(v), "cm-tab"))).setAttribute("role", "presentation"), 
                            g.setAttribute("cm-text", "\t"), e.col += v;
                        } else "\r" == h[0] || "\n" == h[0] ? (g = a.appendChild(A("span", "\r" == h[0] ? "\u240d" : "\u2424", "cm-invalidchar"))).setAttribute("cm-text", h[0]) : ((g = e.cm.options.specialCharPlaceholder(h[0])).setAttribute("cm-text", h[0]), 
                        x && C < 9 ? a.appendChild(A("span", [ g ])) : a.appendChild(g)), e.col += 1;
        ...
        function tn(e, t, n) {
            ...
            if (r) for (var l, a, s, u, c, f, h, d = i.length, p = 0, g = 1, m = "", v = 0; ;) {
                ...
                for (var M = Math.min(d, v); ;) {
                    ...
                    m = i.slice(o, o = n[g++]), l = Xt(n[g++], t.cm.options);
                }
            } else for (var O = 1; O < n.length; O += 2) t.addToken(t, i.slice(o, o = n[O]), Xt(n[O + 1], t.cm.options));
        }
        function nn(e, t, n) {
            this.line = t, this.rest = function(e) {
                for (var t, n; t = Ht(e); ) e = t.find(1, !0).line, (n || (n = [])).push(e);
                return n;
            }(t), this.size = this.rest ? Ye(X(this.rest)) - n + 1 : 1, this.node = this.text = null, 
            this.hidden = Ut(e, t);
        }
        function rn(e, t, n) {
            for (var r, i = [], o = t; o < n; o = r) {
                var l = new nn(e.doc, je(e.doc, o), o);
                r = o + l.size, i.push(l);
            }
            return i;
        }
        ...
        function pn(e, t, n, r) {
            ...
            if (e.options.lineNumbers || o) {
                var l = cn(t), a = t.gutter = A("div", null, "CodeMirror-gutter-wrapper", "left: " + (e.options.fixedGutter ? r.fixedPos : -r.gutterTotalWidth) + "px");
                if (e.display.input.setUneditable(a), l.insertBefore(a, t.text), t.line.gutterClass && (a.className += " " + t.line.gutterClass), 
                !e.options.lineNumbers || o && o["CodeMirror-linenumbers"] || (t.lineNumber = a.appendChild(A("div", Je(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), 
                o) for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
                    var u = e.display.gutterSpecs[s].className, c = o.hasOwnProperty(u) && o[u];
                    c && a.appendChild(A("div", [ c ], "CodeMirror-gutter-elt", "left: " + r.gutterLeft[u] + "px; width: " + r.gutterWidth[u] + "px"));
                }
            }
        }
        function gn(e, t, n) {
        ...
        function vn(e, t, n, r, i) {
            if (t.widgets) for (var o = cn(n), l = 0, a = t.widgets; l < a.length; ++l) {
                var s = a[l], u = A("div", [ s.node ], "CodeMirror-linewidget");
        ...
        function bn(e) {
            ...
            if (!F(document.body, e.node)) {
                ...
                e.noHScroll && (n += "width: " + t.display.wrapper.clientWidth + "px;"), N(t.display.measure, A("div", [ e.node ], null, n));
            }
        ...
        function Sn(e) {
            ...
            var t = N(e.measure, A("pre", "x")), n = window.getComputedStyle ? window.getComputedStyle(t) : t.currentStyle, r = {
        ...
        function An(e, t) {
            ...
            r || (r = function(e, t) {
                var n = Ye(t = Rt(t)), r = e.display.externalMeasured = new nn(e.doc, t, n);
                r.lineN = n;
                ...
                if (3 == l.nodeType) {
                    ...
                    x && C < 11 && (i = function(e, t) {
                        if (!window.screen || null == screen.logicalXDPI || screen.logicalXDPI == screen.deviceXDPI || !function(e) {
                            ...
                            var t = N(e, A("span", "x")), n = t.getBoundingClientRect(), r = L(t, 0, 1).getBoundingClientRect();
        ...
        function Gn(e, t, n) {
            ...
            if ("page" == n) r -= zn(), i -= Bn(); else if ("local" == n || !n) {
        ...
        function Vn(e, t, n, r, i) {
            return r || (r = je(e.doc, t.line)), Kn(e, r, Nn(e, r, t.ch, i), n);
        }
        function qn(r, e, i, o, l, a) {
            function s(e, t) {
                var n = Fn(r, l, e, t ? "right" : "left", a);
                return t ? n.left = n.right : n.right = n.left, Kn(r, o, n, i);
            }
            o = o || je(r.doc, e.line), l || (l = An(r, o));
        ...
        function jn(e, t) {
            ...
            var r = je(e.doc, t.line), i = Gt(r) + xn(e.display);
            return {
                left: n,
                right: n,
                top: i,
        ...
        function $n(e, t, n) {
            ...
            if (o < i) return _n(r.first + r.size - 1, je(r, o).text.length, null, !0, 1);
            t < 0 && (t = 0);
            for (var l = je(r, i); ;) {
                var a = Qn(e, l, i, t, n), s = It(l, a.ch + (0 < a.xRel ? 1 : 0));
                if (!s) return a;
                var u = s.find(1);
        ...
        function Yn(e, t, n, r) {
            return n || (n = An(e, t)), Xn(e, t, n, Kn(e, t, Fn(e, n, r), "line").top);
        }
        function Zn(e, t, n, r) {
        ...
        function Qn(n, e, t, r, i) {
            i -= Gt(e);
            var o = An(n, e), l = Un(e), a = 0, s = e.text.length, u = !0, c = ce(e, n.doc.direction);
            if (c) {
                var f = (n.options.lineWrapping ? function(e, t, n, r, i, o, l) {
                    var a = Xn(e, t, r, l), s = a.begin, u = a.end;
                    ...
                    var e = le(function(e) {
                        ...
                        return Zn(qn(r, et(o, n ? t.to : t.from, n ? "before" : "after"), "line", i, l), s, u, !0);
                    }, 0, a.length - 1), t = a[e];
                    if (0 < e) {
                        var n = 1 != t.level, c = qn(r, et(o, n ? t.from : t.to, n ? "after" : "before"), "line", i, l);
            ...
            if (g) {
                ...
                var w = qn(n, et(t, m, d), "line", e, o);
                h = w.left, v = i < w.top || i >= w.bottom;
            }
            return _n(t, m = oe(e.text, m, 1), d, v, r - h);
        }
        function Jn(e) {
            ...
            return 3 < n && (e.cachedTextHeight = n), T(e.measure), n || 1;
        }
        function er(e) {
        ...
        function rr(r) {
            var i = Jn(r.display), o = r.options.lineWrapping, l = o && Math.max(5, r.display.scroller.clientWidth / er(r.display) - 3);
            return function(e) {
        ...
        function or(e, t, n, r) {
            ...
            var s, u = $n(e, o, l);
            if (r && 1 == u.xRel && (s = je(e.doc, u.line).text).length == u.ch) {
        ...
        function ar(e, t, n, r) {
            ...
            e.curOp.viewChanged = !0, t >= i.viewTo) Ct && zt(e.doc, t) < i.viewTo && ur(e); else if (n <= i.viewFrom) Ct && Bt(e.doc, n + r) > i.viewFrom ? ur(e) : (i.viewFrom += r, 
        ...
        function pr(e, t, n) {
            var r = qn(e, t, "div", null, null, !e.options.singleCursorHeightPerLine), i = n.appendChild(A("div", "\xa0", "CodeMirror-cursor"));
            if (i.style.left = r.left + "px", i.style.top = r.top + "px", i.style.height = Math.max(0, r.bottom - r.top) * e.options.cursorHeight + "px", 
            r.other) {
                var o = n.appendChild(A("div", "\xa0", "CodeMirror-cursor CodeMirror-secondarycursor"));
        ...
        function mr(l, e, t) {
            var n = l.display, r = l.doc, i = document.createDocumentFragment(), o = Sn(l.display), M = o.left, T = Math.max(n.sizerWidth, Ln(l) - n.sizer.offsetLeft) - o.right, N = "ltr" == r.direction;
            function O(e, t, n, r) {
                t < 0 && (t = 0), t = Math.round(t), r = Math.round(r), i.appendChild(A("div", null, "CodeMirror-selected", "position: absolute; left: " + e + "px;\n                             top: " + t + "px; width: " + (null == n ? T - e : n) + "px;\n                             height: " + (r - t) + "px"));
            }
            function a(n, y, b) {
                var w, x, o = je(r, n), C = o.text.length;
                function S(e, t) {
                    return Vn(l, et(n, e), "div", o, t);
                }
                function k(e, t, n) {
                    var r = Yn(l, o, null, e), i = "ltr" == t == ("after" == n) ? "left" : "right";
                ...
                return function(e, t, n, r) {
                    ...
                    if (l.top - o.top <= 3) {
                        var f = (N ? s : a) && c, h = (N ? a : s) && u ? M : (i ? o : l).left, d = f ? T : (i ? l : o).right;
                        O(h, o.top, d - h, o.bottom);
                    } else {
                        var p, g, m, v;
                        i ? (p = N && a && u ? M : o.left, g = N ? T : k(e, n, "before"), m = N ? M : k(t, n, "after"), 
                        v = N && s && c ? T : l.right) : (p = N ? k(e, n, "before") : M, g = !N && a && u ? T : o.right, 
                        m = !N && s && c ? M : l.left, v = N ? k(t, n, "after") : T), O(p, o.top, g - p, o.bottom), 
                        o.bottom < l.top && O(M, o.bottom, null, l.top), O(m, l.top, v - m, l.bottom);
                    }
            ...
            if (s.line == u.line) a(s.line, s.ch, u.ch); else {
                var c = je(r, s.line), f = je(r, u.line), h = Rt(c) == Rt(f), d = a(s.line, s.ch, h ? c.text.length + 1 : null).end, p = a(u.line, h ? 0 : null, u.ch).start;
                h && (d.top < p.top - 2 ? (O(d.right, d.top, null, d.bottom), O(M, p.top, p.left, p.bottom)) : O(d.right, d.top, p.left - d.right, d.bottom)), 
                d.bottom < p.top && O(M, d.bottom, null, p.top);
            }
            t.appendChild(i);
        }
        function vr(e) {
        ...
        function xr(e, t) {
            ...
            M(e.display.wrapper, "CodeMirror-focused")), clearInterval(e.display.blinker), setTimeout(function() {
        ...
        function Cr(e) {
            for (var t = e.display, n = t.lineDiv.offsetTop, r = 0; r < t.view.length; r++) {
                ...
                if (!i.hidden) {
                    ...
                    if ((.005 < c || c < -.005) && (Xe(i.line, l), Sr(i.line), i.rest)) for (var f = 0; f < i.rest.length; f++) Sr(i.rest[f]);
        ...
        function kr(e, t, n) {
            ...
            if (n && n.ensure) {
                ...
                a < o ? l = Ze(t, Gt(je(t, o = a)) + e.wrapper.clientHeight) : Math.min(s, t.lastLine()) >= l && (o = Ze(t, Gt(je(t, s)) - e.wrapper.clientHeight), 
                l = s);
            }
            return {
                from: o,
        ...
        function Lr(e, t) {
            ...
            t.top < 0 && (t.top = 0);
            var i = e.curOp && null != e.curOp.scrollTop ? e.curOp.scrollTop : n.scroller.scrollTop, o = Mn(e), l = {};
        ...
        function Or(e) {
            ...
            t && (e.curOp.scrollToPos = null, Ar(e, jn(e, t.from), jn(e, t.to), t.margin));
        }
        function Ar(e, t, n, r) {
            var i = Lr(e, {
        ...
        Hr.prototype.update = function(e) {
            ...
            this.disableHoriz = new z(), this.disableVert = new z();
        ...
        function Er(e, t) {
            ...
            Rr(e, Pr(e)), n = e.display.barWidth, r = e.display.barHeight;
        }
        function Rr(e, t) {
        ...
        function Br(n) {
            n.display.scrollbars && (n.display.scrollbars.clear(), n.display.scrollbars.addClass && M(n.display.wrapper, n.display.scrollbars.addClass)), 
            n.display.scrollbars = new zr[n.options.scrollbarStyle](function(e) {
        ...
        function Gr(e) {
            ...
            t && function(e, t) {
                ...
                !function(e) {
                    ...
                    for (var l = 0; l < t.length; l++) jr(t[l]);
                    for (var a = 0; a < t.length; a++) _r(t[a]);
                }(e);
            });
        }
        function Vr(e) {
            ...
            n.sizer.style.borderRightWidth = kn(t) + "px", n.scrollbarsClipped = !0), e.updateMaxLine && qt(r), 
        ...
        function _r(e) {
            ...
            e.scrollToPos) && function(e, t) {
                ...
                for (var o = 0; o < 5; o++) {
                    var l = !1, a = qn(e, t), s = n && n != t ? qn(e, n) : a, u = Lr(e, i = {
        ...
        function Qr(e, t) {
            e.doc.highlightFrontier < e.display.viewTo && e.state.highlight.set(t, I(Jr, e));
        }
        function Jr(s) {
            var u = s.doc;
        ...
        function ti(e, t) {
            ...
            c.viewTo = u, n.viewOffset = Gt(je(e.doc, n.viewFrom)), e.display.mover.style.top = n.viewOffset + "px";
            var h = fr(e);
            ...
            return 4 < h && (n.lineDiv.style.display = "none"), function(n, e, t) {
                ...
                for (var s = r.view, u = r.viewFrom, c = 0; c < s.length; c++) {
                    ...
                    if (f.hidden) ; else if (f.node && f.node.parentNode == o) {
                        ...
                        f.changes && (-1 < B(f.changes, "gutter") && (h = !1), un(n, f, u, t)), h && (T(f.lineNumber), 
                        f.lineNumber.appendChild(document.createTextNode(Je(n.options, u)))), l = f.node.nextSibling;
                    } else {
            ...
            }(d), T(n.cursorDiv), T(n.selectionDiv), n.gutters.style.height = n.sizer.style.minHeight = 0, 
            f && (n.lastWrapHeight = t.wrapperHeight, n.lastWrapWidth = t.wrapperWidth, Qr(e, 400)), 
        ...
        function ai(e) {
            ...
            if (n.length != r.lineNumChars) {
                var i = r.measure.appendChild(A("div", [ A("div", n) ], "CodeMirror-linenumber CodeMirror-gutter-elt")), o = i.firstChild.offsetWidth, l = i.offsetWidth - o;
        ...
        function ui(e) {
            ...
            for (var r = 0; r < n.length; ++r) {
                var i = n[r], o = i.className, l = i.style, a = t.appendChild(A("div", null, "CodeMirror-gutter " + o));
        ...
        function fi(e, t, n, r) {
            var i = this;
            this.input = n, i.scrollbarFiller = A("div", null, "CodeMirror-scrollbar-filler"), 
            i.scrollbarFiller.setAttribute("cm-not-content", "true"), i.gutterFiller = A("div", null, "CodeMirror-gutter-filler"), 
            i.gutterFiller.setAttribute("cm-not-content", "true"), i.lineDiv = O("div", null, "CodeMirror-code"), 
            i.selectionDiv = A("div", null, null, "position: relative; z-index: 1"), i.cursorDiv = A("div", null, "CodeMirror-cursors"), 
            i.measure = A("div", null, "CodeMirror-measure"), i.lineMeasure = A("div", null, "CodeMirror-measure"), 
            ...
            i.mover = A("div", [ o ], null, "position: relative"), i.sizer = A("div", [ i.mover ], "CodeMirror-sizer"), 
            i.sizerWidth = null, i.heightForcer = A("div", null, null, "position: absolute; height: " + U + "px; width: 1px;"), 
            i.gutters = A("div", null, "CodeMirror-gutters"), i.lineGutter = null, i.scroller = A("div", [ i.sizer, i.heightForcer, i.gutters ], "CodeMirror-scroll"), 
            i.scroller.setAttribute("tabIndex", "-1"), i.wrapper = A("div", [ i.scrollbarFiller, i.gutterFiller, i.scroller ], "CodeMirror"), 
        ...
        function Mi(e) {
            ...
            }), e.doc.modeFrontier = e.doc.highlightFrontier = e.doc.first, Qr(e, 100), e.state.modeGen++, 
            e.curOp && ar(e);
        }
        function Ti(e, t) {
        ...
        function Ni(e, r, t, i) {
            ...
            function n(e, t, n) {
                !function(e, t, n, r) {
                    ...
                    null != e.order && (e.order = null), Nt(e), Ot(e, n);
                    var i = r ? r(e) : 1;
                    i != e.height && Xe(e, i);
                }(e, t, n, i), an(e, "change", e, r);
            }
            function l(e, t) {
                for (var n = [], r = e; r < t; ++r) n.push(new jt(u[r], o(r), i));
                return n;
            }
            var a = r.from, s = r.to, u = r.text, c = je(e, a.line), f = je(e, s.line), h = X(u), d = o(u.length - 1), p = s.line - a.line;
            if (r.full) e.insert(0, l(0, u.length)), e.remove(u.length, e.size - u.length); else if (Ti(e, r)) {
                ...
                m.push(new jt(h + c.text.slice(s.ch), d, i)), n(c, c.text.slice(0, a.ch) + u[0], o(0)), 
                e.insert(a.line + 1, m);
        ...
        function Ai(e, t) {
            ...
            ir((e.doc = t).cm = e), Li(e), Fi(e), e.options.lineWrapping || qt(e), e.options.mode = t.modeOption, 
            ar(e);
        }
        function Fi(e) {
        ...
        function Wi(e, t) {
            ...
            return Ri(e, n, t.from.line, t.to.line + 1), Oi(e, function(e) {
        ...
        function Hi(e, t, n, r) {
            ...
            X(a.done)) : a.done.length && !X(a.done).ranges ? X(a.done) : 1 < a.done.length && !a.done[a.done.length - 2].ranges ? (a.done.pop(), 
            X(a.done)) : void 0)) l = X(o.changes), 0 == tt(t.from, t.to) && 0 == tt(t.from, l.to) ? l.to = xi(t) : o.changes.push(Wi(e, t)); else {
                var u = X(i.done);
        ...
        function Ii(e, t, n, r) {
            ...
            o = c, l = X(u.done), a = t, "*" == (s = o.charAt(0)) || "+" == s && l.ranges.length == a.ranges.length && l.somethingSelected() == a.somethingSelected() && new Date() - i.history.lastSelTime <= (i.cm ? i.cm.options.historyEventDelay : 500))) ? u.done[u.done.length - 1] = t : Ei(t, u.done), 
                ...
                if (o.ranges) r.push(n ? vi.prototype.deepCopy.call(o) : o); else {
                    ...
                    for (var s = 0; s < l.length; ++s) {
                        ...
                        if (a.push({
                            ...
                            to: u.to,
                            text: u.text
                        }), t) for (var f in u) (c = f.match(/^spans_(\d+)$/)) && -1 < B(t, Number(c[1])) && (X(a)[f] = u[f], 
                        delete u[f]);
                    }
                }
            }
        ...
        function Gi(e, t, n, r, i) {
            null == i && (i = e.cm && (e.cm.display.shift || e.extend)), $i(e, new vi([ Ki(e.sel.primary(), t, n, i) ], 0), r);
        }
        function Vi(e, t, n) {
            for (var r = [], i = e.cm && (e.cm.display.shift || e.extend), o = 0; o < e.sel.ranges.length; o++) r[o] = Ki(e.sel.ranges[o], t[o], null, i);
            $i(e, bi(e.cm, r, e.sel.primIndex), n);
        }
        function qi(e, t, n, r) {
            var i = e.sel.ranges.slice(0);
            i[t] = n, $i(e, bi(e.cm, i, e.sel.primIndex), r);
        }
        function ji(e, t, n, r) {
            $i(e, wi(t, n), r);
        }
        function _i(e, t, n) {
            ...
            i && i.ranges ? Xi(e, r[r.length - 1] = t, n) : $i(e, t, n);
        }
        function $i(e, t, n) {
        ...
        function Xi(e, t, n) {
            ...
            t = l.ranges != i.ranges ? bi(r.cm, l.ranges, l.ranges.length - 1) : i), Yi(e, Qi(e, t, n && n.bias || (tt(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1), !0)), 
            n && !1 === n.scroll || !e.cm || Tr(e.cm);
        }
        function Yi(e, t) {
            ...
            if (o.markedSpans) for (var l = 0; l < o.markedSpans.length; ++l) {
                ...
                if ((null == a.from || (s.inclusiveLeft ? a.from <= t.ch : a.from < t.ch)) && (null == a.to || (s.inclusiveRight ? a.to >= t.ch : a.to > t.ch))) {
                    ...
                    if (n) {
                        ...
                        u && u.line == t.line && (c = tt(u, n)) && (r < 0 ? c < 0 : 0 < c)) return Ji(e, u, t, r, i);
                    }
        ...
        function eo(e, t, n, r, i) {
            var o = r || 1, l = Ji(e, t, n, o, i) || !i && Ji(e, t, n, o, !0) || Ji(e, t, n, -o, i) || !i && Ji(e, t, n, -o, !0);
            return l || (e.cantEdit = !0, et(e.first, 0));
        }
        function to(e, t, n, r) {
            return n < 0 && 0 == t.ch ? t.line > e.first ? at(e, et(t.line - 1)) : null : 0 < n && t.ch == (r || je(e, t.line)).text.length ? t.line < e.first + e.size - 1 ? et(t.line + 1, 0) : null : new et(t.line, t.ch + n);
        }
        function no(e) {
        ...
        function oo(e, n) {
            if (1 != n.text.length || "" != n.text[0] || 0 != tt(n.from, n.to)) {
                var t = Si(e, n);
                Hi(e, n, t, e.cm ? e.cm.curOp.id : NaN), so(e, n, t, Mt(e, n));
                var r = [];
                Oi(e, function(e, t) {
                    t || -1 != B(r, e.history) || (ho(e.history, n), r.push(e.history)), so(e, n, null, Mt(e, n));
                });
            }
        }
        function lo(i, o, e) {
            ...
            if (!t || e) {
                ...
                if (u != a.length) {
                    for (n.lastOrigin = n.lastSelOrigin = null; ;) {
                        ...
                        if (Ei(l, s), e && !l.equals(i.sel)) return void $i(i, l, {
                            clearRedo: !1
                        });
                        r = l;
                    }
        ...
        function so(e, t, n, r) {
            ...
            if (t.to.line < e.first) ao(e, t.text.length - 1 - (t.to.line - t.from.line)); else if (!(t.from.line > e.lastLine())) {
                ...
                t.to.line > o && (t = {
                    ...
                    text: [ t.text[0] ],
                    origin: t.origin
                }), t.removed = _e(e, t.from, t.to), n || (n = Si(e, t)), e.cm ? function(e, t, n) {
                    var r = e.doc, i = e.display, o = t.from, l = t.to, a = !1, s = o.line;
                    e.options.lineWrapping || (s = Ye(Rt(je(r, o.line))), r.iter(s, l.line + 1, function(e) {
                    ...
                    t.full ? ar(e) : o.line != l.line || 1 != t.text.length || Ti(e.doc, t) ? ar(e, o.line, l.line + 1, u) : sr(e, o.line, "text");
        ...
        function po(e, t, n, r) {
            var i = t, o = t;
            return "number" == typeof t ? o = je(e, lt(e, t)) : i = Ye(t), null == i ? null : (r(o, i) && e.cm && sr(e.cm, i, n), 
            o);
        }
        function go(e) {
        ...
        function yo(e, t, n) {
            Gt(t) < (e.curOp && e.curOp.scrollTop || e.doc.scrollTop) && Mr(e, n);
        }
        vo.prototype.clear = function() {
            ...
            if (null != r && t) {
                ...
                var o = bn(this);
                Xe(n, Math.max(0, n.height - o)), e && ($r(e, function() {
            ...
            this.height = null;
            var i = bn(this) - t;
            i && (Ut(this.doc, r) || Xe(r, r.height + i), n && $r(n, function() {
                n.curOp.forceUpdate = !0, yo(n, r, i), an(n, "lineWidgetChanged", n, e, Ye(r));
            }));
        }, be(vo);
        ...
        function xo(t, r, i, e, n) {
            ...
            if (t.cm && !t.cm.curOp) return Xr(t.cm, xo)(t, r, i, e, n);
            var o = new wo(t, n), l = tt(r, i);
            if (e && E(e, o, !1), 0 < l || 0 == l && !1 !== o.clearWhenEmpty) return o;
            if (o.replacedWith && (o.collapsed = !0, o.widgetNode = O("span", [ o.replacedWith ], "CodeMirror-widget"), 
            ...
            if (t.iter(s, i.line + 1, function(e) {
                var t, n;
                u && o.collapsed && !u.options.lineWrapping && Rt(e) == u.display.maxLine && (a = !0), 
                o.collapsed && s != r.line && Xe(e, 0), t = e, n = new St(o, s == r.line ? r.ch : null, s == i.line ? i.ch : null), 
        ...
        wo.prototype.clear = function() {
            ...
            if (!this.explicitlyCleared) {
                ...
                for (var i = null, o = null, l = 0; l < this.lines.length; ++l) {
                    ...
                    t && !e.collapsed ? sr(t, Ye(a), "text") : t && (null != s.to && (o = Ye(a)), null != s.from && (i = Ye(a))), 
                    a.markedSpans = Lt(a.markedSpans, s), null == s.from && e.collapsed && !Ut(e.doc, a) && t && Xe(a, Jn(t.display));
                }
                if (t && this.collapsed && !t.options.lineWrapping) for (var u = 0; u < this.lines.length; ++u) {
                    var c = Rt(e.lines[u]), f = Vt(c);
            ...
            for (var i = 0; i < this.lines.length; ++i) {
                ...
                if (null != l.from && (n = et(t ? o : Ye(o), l.from), -1 == e)) return n;
                if (null != l.to && (r = et(t ? o : Ye(o), l.to), 1 == e)) return r;
            }
            return n && {
                from: n,
                to: r
            ...
            l && s && $r(s, function() {
                var e = l.line, t = Ye(l.line), n = On(s, t);
        ...
        var Lo = 0, Mo = function(e, t, n, r, i) {
            ...
            null == n && (n = 0), mo.call(this, [ new go([ new jt("", null) ]) ]), this.first = n, 
        ...
        Mo.prototype = Q(mo.prototype, {
            ...
            setValue: Zr(function(e) {
                ...
                io(this, {
                    ...
                    origin: "setValue",
                    full: !0
                }, !0), this.cm && Nr(this.cm, 0, 0), $i(this, wi(t), G);
            }),
            ...
            getLineHandle: function(e) {
                if (Qe(this, e)) return je(this, e);
            },
            getLineNumber: function(e) {
                return Ye(e);
            },
            getLineHandleVisualStart: function(e) {
                return "number" == typeof e && (e = je(this, e)), Rt(e);
            },
            lineCount: function() {
                return this.size;
            },
            ...
            setCursor: Zr(function(e, t, n) {
                ji(this, at(this, "number" == typeof e ? et(e, t || 0) : e), null, n);
            }),
            setSelection: Zr(function(e, t, n) {
                ji(this, at(this, e), at(this, t || e), n);
            }),
            ...
            extendSelectionsBy: Zr(function(e, t) {
                Vi(this, st(this, Y(this.sel.ranges, e)), t);
            }),
            setSelections: Zr(function(e, t, n) {
                if (e.length) {
                    for (var r = [], i = 0; i < e.length; i++) r[i] = new yi(at(this, e[i].anchor), at(this, e[i].head));
                    null == t && (t = Math.min(e.length - 1, this.sel.primIndex)), $i(this, bi(this.cm, r, t), n);
                }
            }),
            addSelection: Zr(function(e, t, n) {
                var r = this.sel.ranges.slice(0);
                r.push(new yi(at(this, e), at(this, t || e))), $i(this, bi(this.cm, r, r.length - 1), n);
            }),
            ...
            replaceSelections: Zr(function(e, t, n) {
                ...
                a ? _i(this, a) : this.cm && Tr(this.cm);
            }),
            undo: Zr(function() {
                lo(this, "undo");
            }),
            ...
            addLineWidget: Zr(function(e, t, n) {
                ...
                po(r, i, "widget", function(e) {
                    ...
                    o.line = e, l && !Ut(r, e)) {
                        ...
                        Xe(e, e.height + bn(o)), n && Mr(l, o.height), l.curOp.forceUpdate = !0;
                    }
                    return !0;
                }), l && an(l, "lineWidgetAdded", l, o, "number" == typeof i ? i : Ye(i)), o;
                var r, i, o, l;
            }),
            ...
            findMarksAt: function(e) {
                var t = [], n = je(this, (e = at(this, e)).line).markedSpans;
            ...
            copy: function(e) {
                var t = new Mo($e(this, this.first, this.first + this.size), this.modeOption, this.first, this.lineSep, this.direction);
            ...
            linkedDoc: function(e) {
                ...
                var r = new Mo($e(this, t, n), e.mode || this.modeOption, t, this.lineSep, this.direction);
                ...
                if (o && !i.isReadOnly()) if (t && t.length && window.FileReader && window.File) for (var l = t.length, a = Array(l), s = 0, n = function(e, n) {
                    ...
                    try {
                        ...
                        if (u) {
                            ...
                            Xi(i.doc, wi(o, o)), c) for (var f = 0; f < c.length; ++f) uo(i.doc, "", c[f].anchor, c[f].head, "drag");
        ...
        function Bo(e) {
            ...
            for (var n in e) if (e.hasOwnProperty(n)) {
                ...
                for (var i = Y(n.split(" "), zo), o = 0; o < i.length; o++) {
        ...
        function jo(t, e) {
            for (var n = t.doc.sel.ranges, r = [], i = 0; i < n.length; i++) {
                for (var o = e(n[i]); r.length && tt(o.from, X(r).to) <= 0; ) {
                    var l = r.pop();
        ...
        function Xo(e, t, n, r, i) {
            if (e) {
                ...
                if (o) {
                    var l, a = i < 0 ? X(o) : o[0], s = i < 0 == (1 == a.level) ? "after" : "before";
                    if (0 < a.level || "rtl" == t.doc.direction) {
                        ...
                        }, i < 0 == (1 == a.level) ? a.from : a.to - 1, l), "before" == s && (l = _o(n, l, 1));
        ...
        }, Ro.default = w ? Ro.macDefault : Ro.pcDefault;
        var Yo = {
            selectAll: no,
            ...
            killLine: function(n) {
                return jo(n, function(e) {
                    if (e.empty()) {
                        var t = je(n.doc, e.head.line).text.length;
            ...
            goLineLeftSmart: function(r) {
                return r.extendSelectionsBy(function(e) {
                    ...
                    return n.ch < r.getLine(n.line).search(/\S/) ? Qo(r, e.head) : n;
                }, q);
            },
            goLineUp: function(e) {
            ...
            insertSoftTab: function(e) {
                for (var t = [], n = e.listSelections(), r = e.options.tabSize, i = 0; i < n.length; i++) {
                    var o = n[i].from(), l = R(e.getLine(o.line), o.ch, r);
                    t.push($(r - l % r));
                }
            ...
            transposeChars: function(l) {
                return $r(l, function() {
                    for (var e = l.listSelections(), t = [], n = 0; n < e.length; n++) if (e[n].empty()) {
                        var r = e[n].head, i = je(l.doc, r.line).text;
        ...
        function Zo(e, t) {
            var n = je(e.doc, t), r = Rt(n);
            return r != n && (t = Ye(r)), Xo(!0, e, r, t, 1);
        }
        function Qo(e, t) {
            var n = Zo(e, t.line), r = je(e.doc, n.line), i = ce(r, e.doc.direction);
            if (!i || 0 == i[0].level) {
        ...
        function ol(e) {
            ...
            if (t.curOp.focus = D(), !me(t, e)) {
                ...
                18 != n || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || function(e) {
                    ...
                    function n(e) {
                        18 != e.keyCode && e.altKey || (M(t, "CodeMirror-crosshair"), pe(document, "keyup", n), 
            ...
            n.shift = e.shiftKey, wn(n, e)) b || (n.scroller.draggable = !1, setTimeout(function() {
                ...
                window.focus(), 1 == a && t.state.selectingText && t.state.selectingText(e), l && function(n, e, r, t, i) {
                    ...
                    return tl(n, Go(o = (1 == e ? "Left" : 2 == e ? "Middle" : "Right") + o, i), i, function(e) {
                        if ("string" == typeof e && (e = Yo[e]), !e) return !1;
                        var t = !1;
                        try {
                    ...
                    e.options.dragDrop && Ne && !e.isReadOnly() && "single" == n && -1 < (i = l.contains(t)) && (tt((i = l.ranges[i]).from(), t) < 0 || 0 < t.xRel) && (0 < tt(i.to(), t) || t.xRel < 0) ? function(t, n, r, i) {
                        var o = t.display, l = !1, a = Xr(t, function(e) {
                        ...
                        y.addNew ? -1 == x ? (x = t.length, $i(b, bi(m, t.concat([ w ]), x), {
                            scroll: !1,
                            origin: "*mouse"
                        })) : 1 < t.length && t[x].empty() && "char" == y.unit && !y.extend ? ($i(b, bi(m, t.slice(0, x).concat(t.slice(x + 1)), 0), {
                            scroll: !1,
                            origin: "*mouse"
                        }), C = b.sel) : qi(b, x, w, V) : ($i(b, new vi([ w ], x = 0), V), C = b.sel);
                        var S = v;
                        function a(e) {
                            if (0 != tt(S, e)) if (S = e, "rectangle" == y.unit) {
                                for (var t = [], n = m.options.tabSize, r = R(je(b, v.line).text, v.ch, n), i = R(je(b, e.line).text, e.ch, n), o = Math.min(r, i), l = Math.max(r, i), a = Math.min(v.line, e.line), s = Math.min(m.lastLine(), Math.max(v.line, e.line)); a <= s; a++) {
                                    var u = je(b, a).text, c = j(u, o, n);
                                    o == l ? t.push(new yi(et(a, c), et(a, c))) : u.length > c && t.push(new yi(et(a, c), et(a, j(u, l, n))));
                                }
                                t.length || t.push(new yi(v, v)), $i(b, bi(m, C.ranges.slice(0, x).concat(t), x), {
                                    origin: "*mouse",
                                    scroll: !1
                                }), m.scrollIntoView(e);
                            } else {
                                ...
                                g[x] = function(e, t) {
                                    var n = t.anchor, r = t.head, i = je(e.doc, n.line);
                                ...
                                }(m, new yi(at(b, p), f)), $i(b, bi(m, g, x), V);
                            }
                        }
                        ...
                        var i = Xr(m, function(e) {
                            0 !== e.buttons && Le(e) ? function e(t) {
                                ...
                                if (0 != tt(r, S)) {
                                    m.curOp.focus = D(), a(r);
                                    var i = kr(l, b);
                                    (r.line >= i.to || r.line < i.from) && setTimeout(Xr(m, function() {
                                        u == n && e(t);
                                    }), 150);
                                } else {
                                    var o = t.clientY < s.top ? -20 : t.clientY > s.bottom ? 20 : 0;
                                    o && setTimeout(Xr(m, function() {
        ...
        function xl(e) {
            ...
            e.display.sizerWidth = null) : (M(e.display.wrapper, "CodeMirror-wrap"), qt(e)), 
            ir(e), ar(e), Rn(e), setTimeout(function() {
                return Er(e);
            }, 100);
        }
        function Cl(e, t) {
            ...
            var r = t.value;
            "string" == typeof r ? r = new Mo(r, t.mode, null, t.lineSeparator, t.direction) : t.mode && (r.modeOption = t.mode), 
            this.doc = r;
            ...
            Br(this), this.state = {
                ...
                var o = i.display;
                he(o.scroller, "mousedown", Xr(i, fl)), he(o.scroller, "dblclick", x && C < 11 ? Xr(i, function(e) {
                    if (!me(i, e)) {
                        var t = or(i, e);
                ...
                he(o.scroller, "touchstart", function(e) {
                    ...
                    over: function(e) {
                        me(i, e) || (!function(e, t) {
                            ...
                            if (n) {
                                ...
                                pr(e, n, r), e.display.dragCursor || (e.display.dragCursor = A("div", null, "CodeMirror-cursors CodeMirror-dragcursors"), 
                    ...
                    start: function(e) {
                        return function(e, t) {
                            if (x && (!e.state.draggingText || +new Date() - To < 100)) Se(t); else if (!me(e, t) && !wn(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()), 
                ...
                he(e, "keyup", function(e) {
                    return ll.call(i, e);
                }), he(e, "keydown", Xr(i, ol)), he(e, "keypress", Xr(i, al)), he(e, "focus", function(e) {
                    return wr(i, e);
                }), he(e, "blur", function(e) {
                    return xr(i, e);
                });
            }(this), Do(), Kr(this), this.curOp.forceUpdate = !0, Ai(this, r), t.autofocus && !h || this.hasFocus() ? setTimeout(I(wr, this), 20) : xr(this), 
        ...
        function kl(e, t, n, r) {
            ...
            var l = e.options.tabSize, a = je(o, t), s = R(a.text, null, l);
            ...
            if (h < u && (f += $(u - h)), f != c) return uo(o, f, et(t, 0), et(t, c.length), "+input"), 
            !(a.stateAfter = null);
        ...
        function Tl(e, t, n, r, i) {
            ...
            for (var f = e.curOp.updateInput, h = r.ranges.length - 1; 0 <= h; h--) {
                ...
                d.empty() && (n && 0 < n ? p = et(p.line, p.ch - n) : e.state.overwrite && !a ? g = et(g.line, Math.min(je(o, g.line).text.length, g.ch + X(s).length)) : a && Ll && Ll.lineWise && Ll.text.join("\n") == t && (p = g = et(p.line, 0)));
                var m = {
                    from: p,
                    to: g,
            ...
            t && !a && Ol(e, t), Tr(e), e.curOp.updateInput < 2 && (e.curOp.updateInput = f), 
        ...
        function Ol(e, t) {
            if (e.options.electricChars && e.options.smartIndent) for (var n = e.doc.sel, r = n.ranges.length - 1; 0 <= r; r--) {
                ...
                if (!(100 < i.head.ch || r && n.ranges[r - 1].head.line == i.head.line)) {
                    ...
                    } else o.electricInput && o.electricInput.test(je(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = kl(e, i.head.line, "smart"));
        ...
        function Wl(r, i, o, e, l) {
            ...
            function s(e) {
                ...
                if (null == (t = l ? function(t, n, a, e) {
                    ...
                    if ("ltr" == t.doc.direction && i.level % 2 == 0 && (0 < e ? i.to > a.ch : i.from < a.ch)) return $o(n, a, e);
                    var o, u = function(e, t) {
                        return _o(n, e instanceof et ? e.ch : e, t);
                    }, l = function(e) {
                        return t.options.lineWrapping ? (o = o || An(t, n), Yn(t, n, o, e)) : {
                            begin: 0,
                            end: n.text.length
                        };
        ...
        function Pl(e, t, n, r) {
            ...
            if ("page" == r) {
                var s = Math.min(e.display.wrapper.clientHeight, window.innerHeight || document.documentElement.clientHeight), u = Math.max(s - .5 * Jn(e.display), 3);
        ...
        var Hl = function(e) {
            ...
            this.polling = new z(), this.composing = null, this.gracePeriod = !1, this.readDOMTimeout = null;
        };
        function Il(e, t) {
            var n = On(e, t.line);
            if (!n || n.hidden) return null;
            var r = je(e.doc, t.line), i = Tn(n, r, t.line), o = ce(r, e.doc.direction), l = "left";
        ...
        function Rl(e, t, n) {
            ...
            for (var i = 0; i < e.display.view.length; i++) {
                ...
                if (o.node == r) return zl(o, t, n);
            }
        }
        function zl(u, e, t) {
            var n = u.text.firstChild, r = !1;
            if (!e || !F(n, e)) return El(et(Ye(u.line), 0), !0);
            if (e == n && (r = !0, e = n.childNodes[t], t = 0, !e)) {
                var i = u.rest ? X(u.rest) : u.line;
                return El(et(Ye(i), i.text.length), r);
            }
            ...
            function a(e, t, n) {
                for (var r = -1; r < (f ? f.length : 0); r++) for (var i = r < 0 ? c.map : f[r], o = 0; o < i.length; o += 3) {
                    var l = i[o + 2];
                    if (l == e || l == t) {
                        var a = Ye(r < 0 ? u.line : u.rest[r]), s = i[o] + n;
        ...
        Hl.prototype.init = function(e) {
            ...
            Fl(s, a.options.spellcheck, a.options.autocorrect, a.options.autocapitalize), he(s, "paste", function(e) {
                me(a, e) || Nl(e, a) || C <= 11 && setTimeout(Xr(a, function() {
            ...
            if (t.display.viewTo == t.display.viewFrom || r.line >= t.display.viewTo || i.line < t.display.viewFrom) e.removeAllRanges(); else {
                var o = Rl(t, e.anchorNode, e.anchorOffset), l = Rl(t, e.focusNode, e.focusOffset);
            ...
            if (null == this.readDOMTimeout && !this.gracePeriod && this.selectionChanged()) {
                ...
                if (!this.composing) {
                    this.rememberSelection();
                    var n = Rl(t, e.anchorNode, e.anchorOffset), r = Rl(t, e.focusNode, e.focusOffset);
                    n && r && $r(t, function() {
                        $i(t.doc, wi(n, r), G), (n.bad || r.bad) && (t.curOp.selectionChanged = !0);
                    });
                }
            }
            ...
            l.line == i.viewFrom || 0 == (e = lr(r, l.line)) ? (t = Ye(i.view[0].line), n = i.view[0].node) : (t = Ye(i.view[e].line), 
            n = i.view[e - 1].node.nextSibling);
            var s, u, c = lr(r, a.line);
            if (c == i.view.length - 1 ? (s = i.viewTo - 1, u = i.lineDiv.lastChild) : (s = Ye(i.view[c + 1].line) - 1, 
            ...
            for (var f = r.doc.splitLines(function(s, e, t, u, c) {
                ...
                function m(e) {
                    if (1 == e.nodeType) {
                        ...
                        if (r) {
                            ...
                            return void (i.length && (n = i[0].find(0)) && g(_e(s.doc, n.from, n.to).join(h)));
                        }
                ...
                return n;
            }(r, n, u, t, s)), h = _e(r.doc, et(t, 0), et(s, je(r.doc, s).text.length)); 1 < f.length && 1 < h.length; ) if (X(f) == X(h)) f.pop(), 
            h.pop(), s--; else {
                if (f[0] != h[0]) break;
                f.shift(), h.shift(), t++;
            }
            for (var d = 0, p = 0, g = f[0], m = h[0], v = Math.min(g.length, m.length); d < v && g.charCodeAt(d) == m.charCodeAt(d); ) ++d;
            for (var y = X(f), b = X(h), w = Math.min(y.length - (1 == f.length ? d : 0), b.length - (1 == h.length ? d : 0)); p < w && y.charCodeAt(y.length - p - 1) == b.charCodeAt(b.length - p - 1); ) ++p;
            ...
            var x = et(t, d), C = et(s, h.length ? X(h).length - p : 0);
            ...
            0 == e.charCode || this.composing || (e.preventDefault(), this.cm.isReadOnly() || Xr(this.cm, Tl)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0));
        ...
        var Bl, Ul, Kl, Gl = function(e) {
            this.cm = e, this.prevInput = "", this.pollingFast = !1, this.polling = new z(), 
        ...
        Gl.prototype.init = function(n) {
            ...
            if (e.options.moveInputWithCursor) {
                var i = qn(e, n.sel.primary().head, "div"), o = t.wrapper.getBoundingClientRect(), l = t.lineDiv.getBoundingClientRect();
            ...
            return $r(t, function() {
                Tl(t, i.slice(l), r.length - l, null, e.composing ? "*compose" : null), 1e3 < i.length || -1 < i.indexOf("\n") ? n.value = e.prevInput = "" : e.prevInput = i, 
            ...
            if (t && !m) {
                r.options.resetSelectionOnContextMenu && -1 == r.doc.sel.contains(t) && Xr(r, $i)(r.doc, wi(t), G);
            ...
            function d() {
                ...
                null != o.selectionStart)) {
                    (!x || x && C < 9) && h();
                    var e = 0, t = function() {
                        i.selForContextMenu == r.doc.sel && 0 == o.selectionStart && 0 < o.selectionEnd && "\u200b" == n.prevInput ? Xr(r, no)(r) : e++ < 10 ? i.detectingSelectAll = setTimeout(t, 500) : (i.selForContextMenu = null, 
                        i.input.reset());
                    };
        ...
        function(i) {
            ...
            e("workTime", 100), e("workDelay", 100), e("flattenSpans", !0, Mi, !0), e("addModeClass", !1, Mi, !0), 
            e("pollInterval", 100), e("undoDepth", 200, function(e, t) {
                return e.doc.history.undoDepth = t;
            }), e("historyEventDelay", 1250), e("viewportMargin", 10, function(e) {
                return e.refresh();
            }, !0), e("maxHighlightLength", 1e4, Mi, !0), e("moveInputWithCursor", !0, function(e, t) {
            ...
            setOption: function(e, t) {
                ...
                n[e] == t && "mode" != e || (n[e] = t, Ul.hasOwnProperty(e) && Xr(this, Ul[e])(this, t, r), 
            ...
            indentLine: Yr(function(e, t, n) {
                ...
                Qe(this.doc, e) && kl(this, e, t, n);
            }),
            indentSelection: Yr(function(e) {
                for (var t = this, n = this.doc.sel.ranges, r = -1, i = 0; i < n.length; i++) {
                    var o = n[i];
                    if (o.empty()) o.head.line > r && (kl(t, o.head.line, e, !0), r = o.head.line, i == t.doc.sel.primIndex && Tr(t)); else {
                        ...
                        0 == l.ch && n.length == c.length && 0 < c[i].from().ch && qi(t.doc, i, new yi(l, c[i].to()), G);
                    }
                }
            }),
            ...
            coordsChar: function(e, t) {
                return $n(this, (e = Gn(this, e, t || "page")).left, e.top);
            },
            ...
            heightAtLine: function(e, t, n) {
                ...
                if ("number" == typeof e) {
                    ...
                    e < this.doc.first ? e = this.doc.first : o < e && (e = o, i = !0), r = je(this.doc, e);
                } else r = e;
                return Kn(this, r, {
                    top: 0,
                    left: 0
            ...
            addWidget: function(e, t, n, r, i) {
                var o, l, a, s = this.display, u = (e = qn(this, at(this.doc, e))).bottom, c = e.left;
            ...
            triggerOnKeyDown: Yr(ol),
            triggerOnKeyPress: Yr(al),
            triggerOnKeyUp: ll,
            triggerOnMouseDown: Yr(fl),
            ...
            moveV: Yr(function(r, i) {
                ...
                if (l.extendSelectionsBy(function(e) {
                    ...
                    var n = Pl(o, t, r, i);
                    return "page" == i && e == l.sel.primary() && Mr(o, Vn(o, n, "div").top - t.top), 
                    n;
                }, q), a.length) for (var e = 0; e < l.sel.ranges.length; e++) l.sel.ranges[e].goalColumn = a[e];
            }),
            findWordAt: function(e) {
                var t = je(this.doc, e.line).text, n = e.ch, r = e.ch;
                if (t) {
            ...
            toggleOverwrite: function(e) {
                null != e && e == this.state.overwrite || ((this.state.overwrite = !this.state.overwrite) ? W(this.display.cursorDiv, "CodeMirror-overwrite") : M(this.display.cursorDiv, "CodeMirror-overwrite"), 
            ...
            scrollIntoView: Yr(function(e, t) {
                ...
                null == e ? (e = {
                    ...
                    from: e,
                    to: null
                }), e.to || (e.to = e.from), e.margin = t || 0, null != e.from.line ? (r = e, Or(n = this), 
                n.curOp.scrollToPos = r) : Ar(this, e.from, e.to, e.margin);
            }),
            ...
            refresh: Yr(function() {
                ...
                ar(this), this.curOp.forceUpdate = !0, Rn(this), Nr(this, this.doc.scrollLeft, this.doc.scrollTop), 
                ii(this.display), (null == e || .5 < Math.abs(e - Jn(this.display))) && ir(this), 
                ge(this, "refresh", this);
            }),
            swapDoc: Yr(function(e) {
                var t = this.doc;
                return t.cm = null, this.state.selectingText && this.state.selectingText(), Ai(this, e), 
                Rn(this), this.display.input.reset(), Nr(this, e.scrollLeft, e.scrollTop), this.curOp.forceScroll = !0, 
        ...
        var Vl, ql = "iter insert remove copy getEditor constructor".split(" ");
        for (var jl in Mo.prototype) Mo.prototype.hasOwnProperty(jl) && B(ql, jl) < 0 && (Cl.prototype[jl] = function(e) {
            return function() {
                return e.apply(this.doc, arguments);
            };
        }(Mo.prototype[jl]));
        return be(Mo), Cl.inputStyles = {
            textarea: Gl,
            contenteditable: Hl
            ...
            return a;
        }, (Vl = Cl).off = pe, Vl.on = he, Vl.wheelEventPixels = gi, Vl.Doc = Mo, Vl.splitLines = De, 
        Vl.countColumn = R, Vl.findColumn = j, Vl.isWordChar = ee, Vl.Pass = K, Vl.signal = ge, 
        Vl.Line = jt, Vl.changeEnd = xi, Vl.scrollbarModel = zr, Vl.Pos = et, Vl.cmpPos = tt, 
        Vl.modes = Ie, Vl.mimeModes = Ee, Vl.resolveMode = Re, Vl.getMode = ze, Vl.modeExtensions = Be, 
        Vl.extendMode = Ue, Vl.copyState = Ke, Vl.startState = Ve, Vl.innerMode = Ge, Vl.commands = Yo, 
        Vl.keyMap = Ro, Vl.keyName = Vo, Vl.isModifierKey = Ko, Vl.lookupKey = Uo, Vl.normalizeKeyMap = Bo, 
        Vl.StringStream = qe, Vl.SharedTextMarker = Co, Vl.TextMarker = wo, Vl.LineWidget = vo, 
        Vl.e_preventDefault = we, Vl.e_stopPropagation = xe, Vl.e_stop = Se, Vl.addClass = W, 
        Vl.contains = F, Vl.rmClass = M, Vl.keyNames = Po, Cl.version = "5.46.0", Cl;
    }, this.CodeMirror = e(), function(d) {
        "use strict";
        function t() {
        ...
        function v(e, t, n) {
            var r, i;
            t.queryText = n, t.query = l(n), e.removeOverlay(t.overlay, o(t.query)), t.overlay = (r = t.query, 
            i = o(t.query), "string" == typeof r ? r = new RegExp(r.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), i ? "gi" : "g") : r.global || (r = new RegExp(r.source, r.ignoreCase ? "gi" : "g")), 
            {
                token: function(e) {
                    r.lastIndex = e.pos;
            ...
            t.annotate = null), t.annotate = e.showMatchesOnScrollbar(t.query, o(t.query)));
        }
        function n(o, t, e, n) {
            var r = p(o);
            if (r.query) return y(o, t);
            var i, l, a, s, u, c = o.getSelection() || r.lastQuery;
            if (c instanceof RegExp && "x^" == c.source && (c = null), e && o.openDialog) {
                var f = null, h = function(e, t) {
                    d.e_stop(t), e && (e != r.queryText && (v(o, r, e), r.posFrom = r.posTo = o.getCursor()), 
                    f && (f.style.opacity = 1), y(o, t.shiftKey, function(e, t) {
                        var n;
                        t.line < 3 && document.querySelector && (n = o.display.wrapper.querySelector(".CodeMirror-dialog")) && n.getBoundingClientRect().bottom - 4 > o.cursorCoords(t, "window").top && ((f = n).style.opacity = .4);
                    }));
                };
                l = w(i = o), a = c, s = h, u = function(e, t) {
                    var n = d.keyName(e), r = o.getOption("extraKeys"), i = r && r[n] || d.keyMap[o.getOption("keyMap")][n];
                    "findNext" == i || "findPrev" == i || "findPersistentNext" == i || "findPersistentPrev" == i ? (d.e_stop(e), 
                    v(o, p(o), t), o.execCommand(i)) : "find" != i && "findPersistent" != i || (d.e_stop(e), 
                    h(t, e));
                }, i.openDialog(l, s, {
                    value: a,
                    selectValueOnOpen: !0,
            ...
            } else m(o, w(o), "Search for:", c, function(e) {
                e && !r.query && o.operation(function() {
                    v(o, r, e), r.posFrom = r.posTo = o.getCursor(), y(o, t);
                });
            });
        }
        function y(n, r, i) {
            n.operation(function() {
                var e = p(n), t = g(n, e.query, r ? e.posFrom : e.posTo);
                (t.find(r) || (t = g(n, e.query, r ? d.Pos(n.lastLine()) : d.Pos(n.firstLine(), 0))).find(r)) && (n.setSelection(t.from(), t.to()), 
                n.scrollIntoView({
                    from: t.from(),
                    to: t.to()
        ...
        function x(t, r, i) {
            t.operation(function() {
                for (var e = g(t, r); e.findNext(); ) if ("string" != typeof r) {
        ...
        function i(h, e) {
            if (!h.getOption("readOnly")) {
                var t = h.getSelection() || p(h).lastQuery, n = '<span class="CodeMirror-search-label">' + (e ? h.phrase("Replace all:") : h.phrase("Replace:")) + "</span>";
                m(h, n + (' <input type="text" style="width: 10em" class="CodeMirror-search-field"/> <span style="color: #888" class="CodeMirror-search-hint">' + h.phrase("(Use /re/ syntax for regexp search)") + "</span>"), n, t, function(f) {
                    f && (f = l(f), m(h, '<span class="CodeMirror-search-label">' + h.phrase("With:") + '</span> <input type="text" style="width: 10em" class="CodeMirror-search-field"/>', h.phrase("Replace with:"), "", function(a) {
                        if (a = r(a), e) x(h, f, a); else {
                            b(h);
                            var s = g(h, f, h.getCursor("from")), u = function() {
                                var e, t, n, r, i, o, l = s.from();
                                !(e = s.findNext()) && (s = g(h, f), !(e = s.findNext()) || l && s.from().line == l.line && s.from().ch == l.ch) || (h.setSelection(s.from(), s.to()), 
                                h.scrollIntoView({
                                    from: s.from(),
                                    to: s.to()
                                }), n = '<span class="CodeMirror-search-label">' + (o = t = h).phrase("Replace?") + "</span> <button>" + o.phrase("Yes") + "</button> <button>" + o.phrase("No") + "</button> <button>" + o.phrase("All") + "</button> <button>" + o.phrase("Stop") + "</button> ", 
                                r = h.phrase("Replace?"), i = [ function() {
                                    c(e);
                                }, u, function() {
                                    x(h, f, a);
                                } ], t.openConfirm ? t.openConfirm(n, i) : confirm(r) && i[0]());
                            }, c = function(n) {
                                s.replace("string" == typeof f ? a : a.replace(/\$(\d)/g, function(e, t) {
                                    return n[t];
                                })), u();
                            };
                            u();
        ...
        d.commands.find = function(e) {
            ...
            n(e, !0, !0, !0);
        }, d.commands.findNext = n, d.commands.findPrev = function(e) {
            n(e, !0);
        }, d.commands.clearSearch = b, d.commands.replace = i, d.commands.replaceAll = function(e) {
            i(e, !0);
        };
        ...
        e.commands.jumpToLine = function(r) {
            var e, t, n, i, o, l, a = r.getCursor();
            t = (l = e = r).phrase("Jump to line:") + ' <input type="text" style="width: 10em" class="CodeMirror-search-field"/> <span style="color: #888" class="CodeMirror-search-hint">' + l.phrase("(Use line:column or scroll% syntax)") + "</span>", 
            n = r.phrase("Jump to line:"), i = a.line + 1 + ":" + a.ch, o = function(e) {
                var t;
                if (e) if (t = /^\s*([\+\-]?\d+)\s*\:\s*(\d+)\s*$/.exec(e)) r.setCursor(s(r, t[1]), Number(t[2])); else if (t = /^\s*([\+\-]?\d+(\.\d+)?)\%\s*/.exec(e)) {
                    var n = Math.round(r.lineCount() * Number(t[1]) / 100);
                    /^[-+]/.test(t[1]) && (n = a.line + n + 1), r.setCursor(n - 1, a.ch);
                } else (t = /^\s*\:?\s*([\+\-]?\d+)\s*/.exec(e)) && r.setCursor(s(r, t[1]), a.ch);
        ...
        function h(e, t, n) {
            ...
            return (r = i.appendChild(document.createElement("div"))).className = n ? "CodeMirror-dialog CodeMirror-dialog-bottom" : "CodeMirror-dialog CodeMirror-dialog-top", 
            "string" == typeof t ? r.innerHTML = t : r.appendChild(t), f.addClass(i, "dialog-opened"), 
            r;
        }
        function d(e, t) {
            e.state.currentNotificationClose && e.state.currentNotificationClose(), e.state.currentNotificationClose = t;
        }
        f.defineExtension("openDialog", function(e, t, n) {
            n || (n = {}), d(this, null);
            var r = h(this, e, n.bottom), i = !1, o = this;
            function l(e) {
                if ("string" == typeof e) s.value = e; else {
                    if (i) return;
                    i = !0, f.rmClass(r.parentNode, "dialog-opened"), r.parentNode.removeChild(r), o.focus(), 
                    n.onClose && n.onClose(r);
                }
            }
            var a, s = r.getElementsByTagName("input")[0];
            return s ? (s.focus(), n.value && (s.value = n.value, !1 !== n.selectValueOnOpen && s.select()), 
            n.onInput && f.on(s, "input", function(e) {
                n.onInput(e, s.value, l);
            }), n.onKeyUp && f.on(s, "keyup", function(e) {
                n.onKeyUp(e, s.value, l);
            }), f.on(s, "keydown", function(e) {
                n && n.onKeyDown && n.onKeyDown(e, s.value, l) || ((27 == e.keyCode || !1 !== n.closeOnEnter && 13 == e.keyCode) && (s.blur(), 
                f.e_stop(e), l()), 13 == e.keyCode && t(s.value, e));
            }), !1 !== n.closeOnBlur && f.on(s, "blur", l)) : (a = r.getElementsByTagName("button")[0]) && (f.on(a, "click", function() {
                l(), o.focus();
            }), !1 !== n.closeOnBlur && f.on(a, "blur", l), a.focus()), l;
        }), f.defineExtension("openConfirm", function(e, t, n) {
            d(this, null);
            var r = h(this, e, n && n.bottom), i = r.getElementsByTagName("button"), o = !1, l = this, a = 1;
            function s() {
                o || (o = !0, f.rmClass(r.parentNode, "dialog-opened"), r.parentNode.removeChild(r), 
                l.focus());
            }
            i[0].focus();
            for (var u = 0; u < i.length; ++u) {
                var c = i[u];
                !function(t) {
                    f.on(c, "click", function(e) {
                        f.e_preventDefault(e), s(), t && t(l);
                    });
                }(t[u]), f.on(c, "blur", function() {
                    --a, setTimeout(function() {
                        a <= 0 && s();
                    }, 200);
                }), f.on(c, "focus", function() {
                    ++a;
                });
            }
        }), f.defineExtension("openNotification", function(e, t) {
            d(this, l);
            var n, r = h(this, e, t && t.bottom), i = !1, o = t && void 0 !== t.duration ? t.duration : 5e3;
            function l() {
                i || (i = !0, clearTimeout(n), f.rmClass(r.parentNode, "dialog-opened"), r.parentNode.removeChild(r));
            }
            return f.on(r, "click", function(e) {
                f.e_preventDefault(e), l();
            }), o && (n = setTimeout(l, o)), l;
        });
        ...
        function l(i, e) {
            ...
            for (var r = e.list, u = 0; u < r.length; ++u) {
                var c = s.appendChild(l.createElement("li")), f = r[u], h = "CodeMirror-hint" + (u != this.selectedHint ? "" : " " + O);
                null != f.className && (h = f.className + " " + h), c.className = h, f.render ? f.render(c, e, f) : c.appendChild(l.createTextNode(f.displayText || A(f))), 
                c.hintId = u;
            }
            ...
            var L, M = b.right - v;
            if (0 < M && (b.right - b.left > v && (s.style.width = v - 5 + "px", M -= b.right - b.left - v), 
            s.style.left = (p = d.left - M) + "px"), x) for (var T = s.firstChild; T; T = T.nextSibling) T.style.paddingRight = o.display.nativeBarWidth + "px";
        ...
        i.prototype = {
            ...
            pick: function(e, t) {
                var n = e.list[t];
                n.hint ? n.hint(this.cm, e, n) : this.cm.replaceRange(A(n), n.from || e.from, n.to || e.to, "complete"), 
            ...
            changeActive: function(e, t) {
                ...
                this.selectedHint != e) {
                    ...
                    n && (n.className = n.className.replace(" " + O, "")), (n = this.hints.childNodes[this.selectedHint = e]).className += " " + O, 
                ...
                if ("xml" == a.mode.name) {
                    ...
                    if (!h && !a.state.tagName || g) {
                        ...
                        if ("string" == l.type || "=" == l.string) {
                            var L, M = (p = e.getRange(D(o.line, Math.max(0, o.ch - 60)), D(o.line, "string" == l.type ? l.start : l.end))).match(/([^\s\u00a0=<>\"\']+)=$/);
                            if (!M || !x.hasOwnProperty(M[1]) || !(L = x[M[1]])) return;
                            if ("function" == typeof L && (L = L.call(this, e)), "string" == l.type) {
                                ...
                                if (/['"]/.test(l.string.charAt(N - 1)) && (r = l.string.charAt(N - 1), s = l.string.substr(T, N - 2)), 
                                T) {
                                    var O = e.getLine(o.line);
                                    O.length > l.end && O.charAt(l.end) == r && l.end++;
                                }
                                f = !0;
                            }
                            for (b = 0; b < L.length; ++b) s && !W(L[b], s, i) || c.push(r + L[b] + r);
                        } else for (var A in "attribute" == l.type && (s = l.string, f = !0), x) !x.hasOwnProperty(A) || s && !W(A, s, i) || c.push(A);
                    }
                    return {
                        list: c,
