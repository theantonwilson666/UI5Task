...
sap.ui.define([
    ...
    var RTAPlugin = BaseRTAPlugin.extend("sap.ushell.plugins.rta-personalize.Component", {
        ...
        init: function () {
            ...
            var bButtonIsVisible = this.mConfig.visible && CheckConditions.checkUI5App(this);
        ...
        _checkForEnabledControls: function () {
            ...
            function addPersonalizableControl (oControl) {
                if (this._aPersonalizableControls.indexOf(oControl) === -1) {
                    ...
                    this._adaptButtonVisibility(sButtonId, CheckConditions.checkUI5App(this));
                }
            }
        ...
        _onAdapt: function (oEvent) {
            if (!CheckConditions.checkFlexEnabledOnStart(this)) {
                this.oTrigger.handleFlexDisabledOnStart();
            } else if (oEvent.getSource().getText() === this.mConfig.i18n.getText("PERSONALIZE_BUTTON_TEXT")) {
                ...
                if (!sSapUiLayer || sSapUiLayer === "USER") {
                    oEvent.getSource().setText(this.mConfig.i18n.getText("END_PERSONALIZE_BUTTON_TEXT"));
