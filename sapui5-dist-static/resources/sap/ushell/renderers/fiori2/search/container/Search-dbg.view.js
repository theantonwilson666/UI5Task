...
sap.ui.define([
    ...
    return sap.ui.jsview("sap.ushell.renderers.fiori2.search.container.Search", {
        ...
        assembleCenterArea: function () {
            ...
            return [that.tableSortDialog, searchResultList, that.searchResultTable, that.searchResultGrid, that.searchResultMap, that.appSearchResult, that.showMoreFooter, that.totalCountHiddenElement];
        },
