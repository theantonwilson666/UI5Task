...
sap.ui.define([], function () {
    ...
    module.TwitterUserNode.prototype = {
        ...
        render: function (oRm) {
            oRm.write('<a target="_blank" rel="noopener noreferrer" style="display:inline" class="sapMLnk" href="https://twitter.com/' + this.user + '">');
    ...
    module.TwitterHashNode.prototype = {
        ...
        render: function (oRm) {
            oRm.write('<a target="_blank" rel="noopener noreferrer" style="display:inline" class="sapMLnk" href="https://twitter.com/hashtag/' + this.tag + '?src=hash">');
    ...
    module.TwitterLinkNode.prototype = {
        ...
        render: function (oRm) {
            /*oRm.write('<a target="_blank" rel="noopener noreferrer" style="display:inline" class="sapMLnk" href="' + this.url + '">');
