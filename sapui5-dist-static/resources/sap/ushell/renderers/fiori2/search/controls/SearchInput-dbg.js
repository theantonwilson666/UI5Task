...
sap.ui.define([
    ...
    sap.m.Input.extend("sap.ushell.renderers.fiori2.search.controls.SearchInput", {
        ...
        onsapenter: function (event) {
            if (!(this._oSuggestionPopup && this._oSuggestionPopup.isOpen() && this._oSuggPopover.getFocusedListItem())) {
        ...
        handleLiveChange: function (oEvent) {
            ...
            if (this._oSuggPopover && this._oSuggPopover.handleListNavigation && !this._oSuggPopover.handleListNavigation.decorated) {
