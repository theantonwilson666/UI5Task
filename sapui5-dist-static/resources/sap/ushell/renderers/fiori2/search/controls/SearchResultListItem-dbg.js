...
], function (ushellLibrary, SearchText, SearchLink, SearchTweet, SearchHelper, SearchRelatedObjectsToolbar, SearchModel) {
    "use strict";
    ...
    return sap.ui.core.Control.extend("sap.ushell.renderers.fiori2.search.controls.SearchResultListItem", {
        ...
        _renderAllAttributes: function (oRm, itemAttributes) {
            ...
            if (itemAttributes.length === 0) {
                oRm.write("<li");
                oRm.write("class=\"sapUshellSearchResultListItem-GenericAttribute sapUshellSearchResultListItem-MainAttribute sapUshellSearchResultListItem-EmptyAttributePlaceholder\"");
                oRm.write("aria-hidden=\"true\"");
                oRm.write("></li>");
                return;
            }
                    ...
                    onAfterRendering: function (event) {
                        ...
                        $parentListItem.on("focusin", function (event) {
                            ...
                            if ($relatedTarget.hasClass("sapUshellSearchResultListItem")
                                || $relatedTarget.closest(".sapUshellSearchResultListItemApps").length > 0
        ...
        showDetails: function (animated) {
            ...
            var sClassesToFind = ".sapUshellSearchResultListItem-Title, .sapUshellSearchResultListItem-AttributeKey, .sapUshellSearchResultListItem-AttributeValueHighlighted";
            that.forwardEllipsis($(that.getDomRef()).find(sClassesToFind));
        ...
        hideDetails: function (animated) {
            ...
            var attributeHeight = resultListItem.find(".sapUshellSearchResultListItem-MainAttribute").outerHeight(true)
                + resultListItem.find(".sapUshellSearchResultListItem-ExpandSpacerAttribute").outerHeight(true);
