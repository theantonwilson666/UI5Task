...
], function (ushellLibrary, SearchShellHelper, SearchConfiguration) {
    "use strict";
            ...
            var link = new sap.m.Link({
                ...
                press: function () {
                    var oCrossAppNavigator = sap.ushell
                        ...
                        && (sap.ushell.Container.getService("SmartNavigation") || sap.ushell.Container.getService("CrossApplicationNavigation"));
