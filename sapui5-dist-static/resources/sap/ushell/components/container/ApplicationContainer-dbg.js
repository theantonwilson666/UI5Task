...
sap.ui.define([
    ...
    */
    ...
    function adjustNwbcUrl (sUrl, sUrlApplicationType, sTargetNavigationMode, bReuseSession) {
        ...
        if ((sUrlApplicationType === "TR" || sUrlApplicationType === "GUI") && new UriParameters(document.URL).get("sap-guitest") === "true") {
            sUrl += sUrl.indexOf("?") >= 0 ? "&" : "?";
    ...
    function buildHTMLElements (oRenderManager, oContainer, aAdditionalDataArray, aInfoArray, sUrl, bIsDelayedRendering, oFlpUriParams) {
        ...
        if (oContainer.getIframePostAllParams() === true) {
            oContainer.setProperty("iframePostAllParams", false, true);
    ...
    function trimURL (sUrl, oIframeUriParams) {
        ...
        return sUrl.split("?")[0] +
            (typeof sHint === "string" ? "?sap-iframe-hint=" + sHint : "");
    }
