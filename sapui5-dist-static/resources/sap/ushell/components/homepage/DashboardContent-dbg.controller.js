...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.homepage.DashboardContent", {
        ...
        _getIndexOfTopGroupInViewPort: function () {
            ...
            var currentTileContainerTopAndBottom;
            for (var index = 0; index < aTileContainersTopAndBottoms.length; index++) {
                currentTileContainerTopAndBottom = aTileContainersTopAndBottoms[index];
