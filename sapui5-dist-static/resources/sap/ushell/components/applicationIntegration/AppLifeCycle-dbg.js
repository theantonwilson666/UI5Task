...
sap.ui.define([
    ...
    function AppLifeCycle () {
        ...
        this.parseStatefulContainerConfiguration = function (oConfStatefulApplicationContainer) {
            ...
            if (new UriParameters(document.URL).get("sap-guitest") === "true") {
                oConfStatefulApplicationContainer = undefined;
            }
        ...
        this.getInMemoryInstance = function (sIntent, sFixedShellHash, sAppPart, sOldShellHash) {
            ...
            var bNavigatingFromHomeWithAppState = (sOldShellHash === "Shell-home" &&
