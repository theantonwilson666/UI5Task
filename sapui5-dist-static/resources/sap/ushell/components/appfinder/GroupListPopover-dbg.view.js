        ...
        _getGroupList: function () {
            if (!this._oGroupList) {
                ...
                this._oGroupList = new List({
                    ...
                    itemPress: [ oController.groupListItemClickHandler, oController ],
                    selectionChange: [ oController.onGroupListSelectionChange, oController ]
                });
        ...
        _getCloseButton: function () {
            if (!this._oCloseButton) {
                ...
                this._oCloseButton = new Button("closeButton", {
                    press: [ oController._switchGroupsPopoverButtonPress, oController ],
