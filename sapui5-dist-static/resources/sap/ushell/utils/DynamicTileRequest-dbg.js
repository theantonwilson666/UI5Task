...
sap.ui.define([
        ...
        this.oPromise = this._resolveDefaults(sUrl, sContentProviderId)
            .then(function (sResolvedUrl) {
                if (sResolvedUrl) {
                    ...
                    this.sRequestPath = oUri.relativeTo(this.sBasePath)
                        .query(URI.decodeQuery(oUri.query())) // we want to keep the query decoded for further processing
                        .href();
     ...
     * @private
     */
    DynamicTileRequest.prototype._extractData = function (oResult) {
        var oData = oResult.d ? oResult.d : oResult;
        ...
        oResult = Object.keys(oData).reduce(function (oAcc, sKey) {
