    ...
    function constructWDAURLParameters (oParams, aMappedDefaultedParameterNames) {
        return new Promise(function (fnResolve, fnReject) {
            ...
            sap.ushell.Container.getService("ShellNavigation")
                .compactParams(oEffectiveParameters, ["sap-xapp-state", "sap-ushell-defaultedParameterNames", "sap-intent-params", "sap-iframe-hint"], undefined /* no Component*/, true /*transient*/)
