...
sap.ui.define([
    ...
    function injectEffectiveParametersIntoWebguiQueryParam (sTransactionQueryParam, oParamsToInject) {
        ...
        return oParsedTransactionQueryParam.transactionParamName + "=" + (bHasParameters && bAllwaysShowSelScreen ? "*" : "") + oParsedTransactionQueryParam.transactionCode + (bHasParameters ? "%20" : "") + aParametersFinal.join("%3b");
    }
