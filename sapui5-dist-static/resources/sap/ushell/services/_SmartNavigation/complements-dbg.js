    ...
    sap.ui.define([], function () {
        if (!oInstance) {
            oInstance = {
                ...
                getBaseHashPart: getBaseHashPart,
                getHashFromOArgs: getHashFromOArgs,
                getPersContainerKey: getPersContainerKey,
                getNavigationOccurrences: getNavigationOccurrences,
                prepareLinksForSorting: prepareLinksForSorting,
                mapClickCountsIntoLinkItems: mapClickCountsIntoLinkItems,
                recordNavigationOccurrences: recordNavigationOccurrences,
                updateHistoryEntryWithCurrentUsage: updateHistoryEntryWithCurrentUsage,
