...
sap.ui.define([
     ...
     * @param {string} sParameters the runtime configuration specified in the <code>sap.ushell.Container.getServiceAsync()</code> call (not evaluated yet)
    ...
    function EndUserFeedback (oAdapter/*, oContainerInterface, sParameters, oServiceConfiguration*/) {
         ...
         *
         * @param {object} Plain object containing the input fields required for the end user feedback.
         * @public
