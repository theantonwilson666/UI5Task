...
sap.ui.define([
     ...
     *
     * <pre>
     * var oSrvc = sap.ushell.Container.getServiceAsync("ClientSideTargetResolution").then(function (ClientSideTargetResolution) {});
    ...
    ClientSideTargetResolution.prototype._getURLParsing = function () {
        if (!this._oURLParsing) {
            Log.error("ClientSideTargetResolution.js: sap.ushell.Container.getSerivce() - sync call triggered.");
     ...
     *
     * @param {array} aInbounds The Inbounds.
        ...
        this._getMatchingInbounds(oShellHash, oInboundIndex, { bExcludeTileInbounds: true })
            ...
            .done(function (aMatchingTargets) {
                ...
                if (aMatchingTargets.length === 0) {
                    Log.warning("Could not resolve " + sHashFragment,
                        "rejecting promise",
                        "sap.ushell.services.ClientSideTargetResolution");
     ...
     *  }
     *</pre>
     *@param {array} [oConstraints.tags]
     *     Tags to which the queried inbounds should belong to.
     *
    ...
    ClientSideTargetResolution.prototype.getEasyAccessSystems = function (sMenuType) {
        ...
        oActionDefinitions = oApplicationType.getEasyAccessMenuDefinitions().reduce(function (oReducibleActionDefs, oEasyAccessMenuDefinition) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            this._oAdapter.resolveSystemAlias(sSystemId)
                .done(function (oResolvedSystemAlias) {
                    oSystemContext = SystemContext.createSystemContextFromSystemAlias(oResolvedSystemAlias);
