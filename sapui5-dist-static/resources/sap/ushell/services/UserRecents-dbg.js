        ...
        this.getRecentItemsHelper = function (maxNumOfActivities) {
            var that = this,
                ...
                getRecentItemsForDevice = function (aLoadedRecents) {
                    ...
                    for (iRecentActivityCounter = 0;
                        iRecentActivityCounter < aLoadedRecents.recentUsageArray.length && (!maxNumOfActivities || iDeviceDependentActivityCounter < maxNumOfActivities);
                        iRecentActivityCounter++) {
