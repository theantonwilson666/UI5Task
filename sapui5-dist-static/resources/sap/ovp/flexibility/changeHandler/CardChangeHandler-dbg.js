sap.ui.define([], function () {
	 ...
	 *
	 * @param {sap.ui.fl.oChange} oChange Change object to be applied on the card
	 * @returns {object} - Condenser specific information
	 */
	HideCardContainer.changeHandler.getCondenserInfo = function(oChange) {
		return {
			affectedControl: oChange.getSelector(),
			classification: sap.ui.fl.condenser.Classification.LastOneWins,
			uniqueKey: oChange.getSelector().id + '-' + oChange.getDefinition().changeType
	 ...
	 * @returns {object} - Condenser specific information
	 */
	UnhideCardContainer.changeHandler.getCondenserInfo = function(oChange) {
		return {
			affectedControl: oChange.getSelector(),
			classification: sap.ui.fl.condenser.Classification.LastOneWins,
			uniqueKey: oChange.getSelector().id + '-' + oChange.getDefinition().changeType
