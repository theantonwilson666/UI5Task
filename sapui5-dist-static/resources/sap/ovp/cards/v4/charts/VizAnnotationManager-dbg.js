...
//		}
            ...
            if (!bEnableStableColors && (chartContext.ChartType.EnumMember === constants.COLUMNSTACKED_CHARTTYPE || chartContext.ChartType.EnumMember === constants.DONUT_CHARTTYPE || chartContext.ChartType.EnumMember === constants.COLUMN_CHARTTYPE || chartContext.ChartType.EnumMember === constants.BAR_CHARTTYPE ||
                        ...
                        if (finalDimensions){
                            each(Object.keys(finalDimensions), function(i, key){
                                if (oMetadata[key]["$Type"] === "Edm.String"){
                                    if (oMetadata[key]["sap:semantics"] === "yearmonth" || oMetadata[key]["annotations"]["@com.sap.vocabularies.Common.v1.IsCalendarYearMonth"]){
                                    ...
                                    }else if (oMetadata[key]["sap:semantics"] === "yearquarter" || oMetadata[key]["annotations"]["@com.sap.vocabularies.Common.v1.IsCalendarYearQuarter"]){
                                    ...
                                    }else if (oMetadata[key]["sap:semantics"] === "yearweek" || oMetadata[key]["annotations"]["@com.sap.vocabularies.Common.v1.IsCalendarYearWeek"]){
