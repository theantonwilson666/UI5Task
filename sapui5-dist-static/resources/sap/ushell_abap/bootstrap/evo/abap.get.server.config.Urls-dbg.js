...
sap.ui.define([
    ...
    function getServerConfigUrls () {
        ...
        if (typeof sHardcodedUrlOrParameterUrl !== "undefined") {
            ...
            var oAllowlist = ObjectPath.get("sap-ushell-config.launchpadConfiguration.configurationFile.configurationFileFolderWhitelist"); // inclusive language FLPCOREANDUX-4020: this configuration parameter is deprecated and will be removed
