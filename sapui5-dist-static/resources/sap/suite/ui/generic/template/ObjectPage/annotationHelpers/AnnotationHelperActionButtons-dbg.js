...
sap.ui.define([
	...
	function isEditButtonRequired(oInterface, mRestrictions, oEntitySet, bParameterEdit, aAncestorTreeNodes, bIsDraftEnabled){
		...
		for (var i = 0; i < aAncestorTreeNodes.length && bIsDraftEnabled; i++) {
	...
	function getEditActionButtonVisibility(oInterface, mRestrictions, oEntitySet, oAppComponent, oTreeNode, aAncestortreeNodes, bIsDraftEnabled) {
