sap.ui.define([
	...
	'sap/ui/comp/odata/FiscalFormat'
		...
		FilterUtil.formatStringDateYearQuarter = function (oDimFieldDisplay) {
			if (oDimFieldDisplay !== "") {
				var oFormatter = DateFormat.getDateTimeInstance({format: "YYYYQ"}),
				year = parseInt(oDimFieldDisplay.substr(0,4), 10),
		...
		FilterUtil.formatStringDateYearWeek = function (oDimFieldDisplay) {
			if (oDimFieldDisplay !== "") {
				var oFormatter = DateFormat.getDateTimeInstance({format: "YYYYWW"}),
				year = parseInt(oDimFieldDisplay.substr(0,4), 10),
		...
		FilterUtil.formatStringFiscalYearPeriod = function (oDimFieldDisplay) {
			if (oDimFieldDisplay !== "") {
				var oFormatter = FiscalFormat.getDateInstance({format: "YYYYPPP"});
				return oFormatter.format(oDimFieldDisplay);
			}
			return oDimFieldDisplay;
		};
