	...
	FilterItemChart.prototype._getLabel = function(oDimFieldDisplay, sDimField) {
		if (this.getDimensionFieldIsDateTime()) {
			if (oDimFieldDisplay instanceof Date) {
				...
				return sDimField === IS_OTHERS ? oDimFieldDisplay : FilterUtil.formatStringDateYearWeek(oDimFieldDisplay);
			} else if (this._isStringDateType() == "yearquarter") {
				return sDimField === IS_OTHERS ? oDimFieldDisplay : FilterUtil.formatStringDateYearQuarter(oDimFieldDisplay);
			} else if (this._isStringDateType() == "fiscalyearperiod") {
				return sDimField === IS_OTHERS ? oDimFieldDisplay : FilterUtil.formatStringFiscalYearPeriod(oDimFieldDisplay);
			} else {
