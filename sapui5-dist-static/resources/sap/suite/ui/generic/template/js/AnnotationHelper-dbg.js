sap.ui.define(["sap/ui/model/odata/AnnotationHelper",
	...
	"sap/m/library",
	"sap/ui/core/library"
], function (AnnotationHelperModel, SmartField, FeLogger, formatMessage, deepExtend, RuntimeFormatters, StableIdHelper, testableHelper, Device, SapMLibrary, SapCoreLibrary) {
	"use strict";
	...
	function getSortOrFilterProperty(oInterface, oDataField, oContextSet, oDataFieldTarget, sAnnotationPath, bSort){
		...
		if (aRecordType.indexOf(oDataField.RecordType) !== -1) {
			...
			if (sAnnotationPath.indexOf('com.sap.vocabularies.Communication.v1.Contact') >= 0) {
				return getBindingForSortFilterContact(oInterface, oContextSet, oDataFieldTarget, sAnnotationPath, bSort);
	...
	function getBindingForSortFilterContact(oInterface, oContextSet, oDataFieldTarget, sAnnotationPath, bSort) {
		var sNavigation = "";
...
*/
		...
		getDefaultWidthForTableColumn: function(oInterface, oDataFieldValue, oDataFieldForWidth, sAnnotationPath, oDataField, bEnableAuto){
			...
			var sWidth = oAnnotationHelper.getDefaultWidthBasedOnAnnotation(oDataFieldForWidth);
			if (sWidth){
				return sWidth;
				...
				var oEntityType = oMetaModel.getODataAssociationEnd(oMetaModel.getODataEntityType(oDataField.entityType), sAnnotationPath.split("/")[0]).type;
		...
		getDefaultWidthBasedOnAnnotation: function (oDataFieldForWidth) {
			if (oDataFieldForWidth && oDataFieldForWidth["com.sap.vocabularies.HTML5.v1.CssDefaults"] && oDataFieldForWidth["com.sap.vocabularies.HTML5.v1.CssDefaults"].width && oDataFieldForWidth["com.sap.vocabularies.HTML5.v1.CssDefaults"].width.String) {
		...
		getSortProperty: function (oInterface, oDataField, oContextSet, oDataFieldTarget, sAnnotationPath) {
			var bSort = true; // retrieve binding for sort property
			return getSortOrFilterProperty(oInterface, oDataField, oContextSet, oDataFieldTarget, sAnnotationPath, bSort);
		},
		getFilterProperty: function (oInterface, oDataField, oContextSet, oDataFieldTarget, sAnnotationPath) {
